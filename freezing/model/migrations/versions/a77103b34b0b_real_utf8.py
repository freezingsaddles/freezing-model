...
def upgrade():
    ...
    op.execute(
        "ALTER TABLE ride_photos CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_bin"
    )
    op.execute("ALTER TABLE rides CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_bin")
    op.execute(
        "ALTER TABLE ride_errors CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_bin"
    )
